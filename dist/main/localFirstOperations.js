...
exports.createAspekKerjaLocalFirst = createAspekKerjaLocalFirst;
exports.updateAspekKerjaLocalFirst = updateAspekKerjaLocalFirst;
exports.deleteAspekKerjaLocalFirst = deleteAspekKerjaLocalFirst;
...
function updateKasTransactionLocalFirst(id, input, updatedBy) {
    try {
        ...
        const syncChanges = { ...input };
        if ('transaction_date' in syncChanges) {
            syncChanges.tanggal = input.transaction_date;
            delete syncChanges.transaction_date;
        }
...
function createAspekKerjaLocalFirst(kode, nama, coaId, jenis, statusAktif) {
    try {
        ...
        electron_log_1.default.error('[LocalFirst] Failed to create Aspek Kerja:', error);
        return { success: false, message: 'Gagal membuat Aspek Kerja', syncStatus: 'error' };
    }
}
function updateAspekKerjaLocalFirst(id, nama, coaId, jenis, statusAktif) {
    try {
        ...
        electron_log_1.default.error('[LocalFirst] Failed to update Aspek Kerja:', error);
        return { success: false, message: 'Gagal mengupdate Aspek Kerja', syncStatus: 'error' };
    }
}
function deleteAspekKerjaLocalFirst(id) {
    try {
        ...
        electron_log_1.default.error('[LocalFirst] Failed to delete Aspek Kerja:', error);
